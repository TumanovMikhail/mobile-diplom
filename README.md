#### ${\color{lightgreen}Выгрузка \space базы \space "Торгового \space предприятия" \space и \space конфигурация \space мобильного \space клиента \space находятся \space в \space релизах \space данного \space репозитория.}$
